...
```sh
  mkdir rails_recipe_app
  cd rails_recipe_app
  git clone https://github.com/TechnoAndy/Rails_Recipe_App
```
...
- GitHub: [@anyepter](https://github.com/anyepter)
- Twitter: [@anyepter](https://twitter.com/anyepeter)
- LinkedIn: [LinkedIn](https://www.linkedin.com/in/anyepeter/)
